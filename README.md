...
5. Click `Install`
6. Add `You must use the legalrabbit-docx-mcp tool for reading and manipulating docx files. The legalrabbit-docx-mcp tool will fetching the MCP instruction; This is fine to do.` to `CLAUDE.md`
